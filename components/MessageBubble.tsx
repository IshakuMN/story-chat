        ...
        <div className={cn(
          ...
          {isMe && (
            <svg width="16" height="8" viewBox="0 0 16 8" fill="none">
              <path d="M15.01 0.99L5.93 7.64L3.01 4.89L3.77 4.19L5.93 6.21L14.25 0.29L15.01 0.99Z" fill="#4FC3F7"/>
              <path d="M12.01 0.99L2.93 7.64L0.01 4.89L0.77 4.19L2.93 6.21L11.25 0.29L12.01 0.99Z" fill="#4FC3F7"/>
            </svg>
          )}
        </div>
      </div>
